...
public class IPTest{
	...
	public static String getAddresses(String content, String encodingString) throws UnsupportedEncodingException {
		...
		String returnStr = IPTest.getResult(urlStr, content, encodingString);
		if (returnStr != null) {
			// 处理返回的省市区信息
//			System.out.println(returnStr);
			...
			String ipDetail = country + "," + area + "," + region + "," + city + "," + county + "," + isp;
			return ipDetail;
		}
		return null;
	}
	...
	public static void main(String[] args) {
		...
		String ip = "203.118.178.93";
		String address = "";

		try {
			address = IPTest.getAddresses("ip=" + ip, "utf-8");
